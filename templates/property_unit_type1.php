            ...
            wpestate_build_unit_custom_structure($wpestate_custom_unit_structure,$post->ID,$wpestate_property_unit_slider);
                ...
                <?php 
                    if(  wpresidence_get_option('property_card_agent_show_featured', '')=='yes' ){ 
                        get_template_part('templates/property_cards_templates/property_card_featured_label');
                    }
                ?>
                ...
                <div class="property-unit-information-wrapper">
                    ...
                    if($wp_estate_use_composer_details =='yes'){         
                        ...
                        get_template_part('templates/property_cards_templates/property_card_adress_type2'); 
                        get_template_part('templates/property_cards_templates/property_card_category_type1'); 
                        get_template_part('templates/property_cards_templates/property_card_details_type1');
                    } 
