        ...
        <div class="agent_unit_social agent_list">
               ...
               <?php
                ...
                if($agent_details['realtor_facebook']!=''){
                    print ' <a class="agent_unit_facebook" href="'. esc_url($agent_details['realtor_facebook']).'" rel="noopener" ><i class="fab fa-facebook-f"></i></a>';
                }

                if($agent_details['realtor_twitter']!=''){
                    print ' <a  class="agent_unit_twitter" href="'.esc_url($agent_details['realtor_twitter']).'" rel="noopener" ><i class="fab fa-twitter"></i></a>';
                }
                
                if($agent_details['realtor_linkedin']!=''){
                    print ' <a  class="agent_unit_linkedin" href="'.esc_url($agent_details['realtor_linkedin']).'" rel="noopener" ><i class="fab fa-linkedin-in"></i></a>';
                }
                
                if($agent_details['realtor_pinterest']!=''){
                    print ' <a  class="agent_unit_pinterest" href="'. esc_url($agent_details['realtor_pinterest']).'" rel="noopener" ><i class="fab fa-pinterest-p"></i></a>';
                }
                
                if($agent_details['realtor_instagram']!=''){
                    print ' <a  class="agent_unit_instagram" href="'. esc_url($agent_details['realtor_instagram']).'" rel="noopener" ><i class="fab fa-instagram"></i></a>';
                }
