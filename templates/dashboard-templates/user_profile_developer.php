...
$developer_about_details_fields= array(
      ...
      'developer_private_notes' => array(
                        'label' =>  esc_html__('Private Notes', 'wpresidence'),
                        'inputype'=>'textarea',
                        'meta_name' =>  'developer_private_notes',
                        'type' =>  'post_meta',
                    ),                  
  );
