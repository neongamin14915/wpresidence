...
<select name="wpestate_schedule_tour_time" id="wpestate_schedule_tour_time">
...
<div class="wpestate_display_schedule_tour_options_wrapper">
    ...
    <div class="wpestate_display_schedule_tour_option shedule_option_selected">
        <?php esc_html_e('In Person','wpresidence');?>
    </div>
    
    <div class="wpestate_display_schedule_tour_option">
