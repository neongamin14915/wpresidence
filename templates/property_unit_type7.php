...
<div class="<?php echo esc_html($col_data['col_class']);?> listing_wrapper property_unit_type7" 
    ...
    <div class="property_listing property_unit_type7 <?php echo wpestate_interior_classes($wpestate_uset_unit); ?> " 
            ...
            wpestate_build_unit_custom_structure($wpestate_custom_unit_structure,$post->ID,$wpestate_property_unit_slider);
                ...
                <?php 
                    if($wp_estate_use_composer_details =='yes'){         
                        wpestate_return_property_card_content($post->ID,7);
                    }else{
                        print  wpestate_return_property_card_categories($post->ID);
                        ...
                        get_template_part('templates/property_cards_templates/property_card_details_type7'); 
                    ...
                    if( wpresidence_get_option('property_card_agent_show_row','')=='yes'){ ?>     
                        <div class="property_location">
                            <?php 
                                include( locate_template  ('/templates/property_cards_templates/property_card_contact.php'));
                            ?>                            
                        </div>    
                    <?php
                    } 
