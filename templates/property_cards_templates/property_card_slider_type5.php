...
if( isset($main_image[0]) ){
    ...
    $main_image_url=   wpresidence_get_option('wp_estate_prop_list_slider_image_palceholder','url');
}
...
if(  $wpestate_property_unit_slider==1){
    ...
    <div id="property_unit_carousel_'.esc_attr($unique_prop_id).'" class="carousel property_unit_carousel slide " data-ride="carousel" data-interval="false">
            <div class="carousel-inner">
                <div class="item active" style="background-image:url( '. esc_url($main_image_url).' )">
