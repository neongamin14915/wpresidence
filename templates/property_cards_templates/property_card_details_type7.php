...
<div class="property_listing_details">
    ...
    <?php 
        if($property_bedrooms!='' && $property_bedrooms!=0){
            print '<div class="property_listing_details_v7_item"  data-original-title="'.esc_attr__('Bedrooms','wpresidence').'" >';
        ...
        if($property_bathrooms!='' && $property_bathrooms!=0){
            print '<div class="property_listing_details_v7_item" data-original-title="'.esc_attr__('Bathrooms','wpresidence').'">';
                print '<div class="icon_label" >';
        ...
        if($property_size!=''){
            print '<div class="property_listing_details_v7_item" data-original-title="'.esc_attr__('Property Size','wpresidence').'" >';
                print '<div class="icon_label" >';
        ...
        if($property_garage_size!=''){
            print '<div class="property_listing_details_v7_item" data-original-title="'.esc_attr__('Garage Size','wpresidence').'" >';
                print '<div class="icon_label"  >';
        ...
        if($property_lot_size!=''){
            print '<div class="property_listing_details_v7_item" data-original-title="'.esc_attr__('Lot Size','wpresidence').'" >';
                print '<div class="icon_label" >';
                    include(locate_template('css/css-images/icons/lotsize7.svg'));
                print'</div>';   
                print trim($property_lot_size);
            print'</div>';   
        }
