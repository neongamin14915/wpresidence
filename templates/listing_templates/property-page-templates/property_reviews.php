...
$wp_estate_no_of_reviews                  =   wpresidence_get_option('wp_estate_no_of_reviews');
if($wp_estate_no_of_reviews==''){
    $wp_estate_no_of_reviews=-1;
}
$args = array(
...
<?php
if($is_tab!='yes'){ //end property_reviews_wrapper ?>
</div>
<?php } ?>