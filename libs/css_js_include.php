...
function wpestate_scripts() {
  ...
  //  wp_enqueue_style( 'font-awesome-5.min',  get_theme_file_uri( '/css/fontawesome/css/all.css') );
   //wp_enqueue_style( 'font-awesome.min',  trailingslashit( get_template_directory_uri() ) . 'css/fontawesome/css/fontawesome.min.css' );
    wp_enqueue_style( 'font-awesome6.4.2.min',  trailingslashit( get_template_directory_uri() ) . 'css/fontawesome/css/all.min.css' );
    ...
    if (is_admin() &&  ( $pagenow=='post-new.php' || $pagenow=='post.php') && ($typenow=='estate_property' || $typenow=='estate_agency' || $typenow=='estate_developer') ) {
        ...
        wp_localize_script('admin_js', 'admin_js_vars',
            array(  'ajaxurl'                   =>  esc_url(admin_url('admin-ajax.php')),
                    ...
                    'confirm_text'              =>  esc_html__(' Are you sure you want to delete this image? It will be removed from property gallery and WordPress media gallery.','wpresidence')
