...
if( !function_exists('wpestate_overview_map_modal') ):
    function wpestate_overview_map_modal($postID){
        $property_address  =   esc_html( get_post_meta($postID, 'property_address', true) );
        ...
        $modal ='<div id="wpestate_overview_map_modal" class="modal wpestate_overview_map_modal" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <h3>'.trim($property_address_show).'</h3>  
                '. $content.'
                </div>       
            </div>
        </div>
